package com.ambgen.naijahookup.commercial_fragments.account;
...
import com.ambgen.naijahookup.activities.CommercialHomeActivity;
...
public class AccountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_commercial_account, container, false);
        ...
        TextView logOut=root.findViewById(R.id.log_out);
         ...
         nationalIdEditText=root.findViewById(R.id.person_id);
        ...
        addAPhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                imagePickerListener.chooseImg(AccountFragment.this);
            }
        });
        ...
        profileRef.addListenerForSingleValueEvent(
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        CommercialModel users=dataSnapshot.child("Users").child(StaticKeys.commercials).child(theId).getValue(CommercialModel.class);
...
//                        Toast.makeText(WorkerHomeActivity.this,users.getImageurl(),Toast.LENGTH_LONG).show();
   ...
   public interface  imagePickerListener{
        void chooseImg(AccountFragment fragment);
    }

    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        imagePickerListener=((CommercialHomeActivity)context);
    }
...
//                                        sendToActivity();
    ...
    public void updateSingleInfo(View v) {
        ...
        signUpMap.put(StaticKeys.nationalid, nationalId.trim());
